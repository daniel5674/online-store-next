...
const dummyProducts = [{
  ...
  },
  {
    ...
    price: 649,
    category: "adidas",
    description: "נעל ריצה מתקדמת עם בולמי זעזועים, נוחות מקסימלית ועיצוב מודרני שמתאים גם ליום-יום.",
    images: [
  ...
  },
  {
    ...
    price: 399,
    category: "adidas",
    description: "דגם רטרו איקוני בעיצוב נועז, עשוי זמש איכותי, מתאים למראה יומיומי עם סטייל.",
    images: [
  ...
  },
  {
    ...
    price: 439,
    category: "adidas",
    description: "נעל קלאסית עם השראה מסגנון הכדורסל של שנות ה-80, מתאימה לאופנת רחוב ייחודית.",
    images: [
  ...
  },
  {
    ...
    price: 589,
    category: "adidas",
    description: "נעל ספורט עירונית עם עיצוב עתידני, סוליית Boost רכה ונוחות יוצאת דופן לאורך כל היום.",
    images: [
  ...
  },
  {
    ...
    price: 359,
    category: "adidas",
    description: "הדגם המפורסם של אדידס במראה לבן נקי עם נגיעה ירוקה – מתאים לכל הופעה.",
    images: [
  ...
  },
  {
    ...
    price: 449,
    category: 'nike',
    description: 'Iconic Nike Air Force 1 sneakers with a timeless design and superior comfort.',
    images: [
  ...
  },
  {
    ...
    price: 589,
    category: "nike",
    description: "נעל נוחה במיוחד עם בולם זעזועים בולט ועיצוב מודרני – מתאימה גם לריצה וגם ליום-יום.",
    images: [
  ...
  },
  {
    ...
    price: 899,
    category: "nike",
    description: "נעל ריצה מקצועית עם טכנולוגיית ZoomX וסוליה עם פחמן – מקסימום ביצועים במינימום משקל.",
    images: [
  ...
  },
  {
    ...
    price: 529,
    category: "nike",
    description: "נעלי כדורסל חתומות ע״י לברון ג׳יימס, מספקות תמיכה, קפיציות וסטייל על המגרש.",
    images: [
  ...
  },
  {
    ...
    price: 459,
    category: "nike",
    description: "נעל גבוהה עם עיצוב רטרו, עור איכותי וסוליה עבה – הבחירה המושלמת לסטייל אורבני.",
    images: [
  ...
  },
  {
    ...
    price: 439,
    category: "nike",
    description: "נעלי סניקרס רטרו עם עיצוב ייחודי וסוליה שטוחה – מושלמות ליום-יום ולסטייל עירוני.",
    images: [
  ...
  },
  {
    ...
    price: 419,
    category: "puma",
    description: "נעל ספורט עיצובית עם סוליה רחבה ובלעדית לנוחות ויציבות לאורך כל היום.",
    images: [
  ...
  },
  {
    ...
    price: 299,
    category: "puma",
    description: "הדגם הקלאסי של פומה בעיצוב זמש על זמני שמתאים לכל הופעה יומיומית.",
    images: [
  ...
  },
  {
    ...
    price: 369,
    category: "puma",
    description: "נעל ספורט צבעונית וקלילה עם השראה רטרו ונוחות מקסימלית לאורך כל היום.",
    images: [
  ...
  },
  {
    ...
    price: 599,
    category: "puma",
    description: "נעל כדורסל מקצועית בעיצוב מודגש, שיתוף פעולה עם למלו בול – יציבות, אחיזה וסטייל.",
    images: [
  ...
  },
  {
    ...
    price: 349,
    category: "puma",
    description: "נעל יומיומית עם עיצוב אלגנטי ונקי, שואבת השראה מדגמי קליפורניה האייקוניים – מושלמת לסטייל אורבני עדכני.",
    images: [
  ...
  },
  {
    ...
    price: 449,
    category: "newbalance",
    description: "נעל רטרו מודרנית בהשראת שנות ה-70 עם עיצוב בולט וסוליה מחוספסת – מושלמת לאופנת רחוב.",
    images: [
  ...
  },
  {
    ...
    price: 429,
    category: "newbalance",
    description: "הדגם האייקוני של ניו באלאנס בעיצוב קלאסי שמשלב נוחות וסגנון יומיומי.",
    images: [
  ...
  },
  {
    ...
    price: 529,
    category: "newbalance",
    description: "נעל סניקרס עם השראה מעולם הכדורסל של שנות ה-80 – שילוב של נוסטלגיה וסטייל עכשווי.",
    images: [
  ...
  },
  {
    ...
    price: 699,
    category: "newbalance",
    description: "דגם פרימיום עם נוחות מקסימלית, ייצור אמריקאי וסוליה מתקדמת – מתאים לריצה ולשימוש יומיומי.",
    images: [
  ...
  },
  {
    ...
    price: 679,
    category: "newbalance",
    description: "נעל ריצה עם טכנולוגיית Fresh Foam X, בולמת זעזועים מושלמת לרצים מקצועיים וחובבים.",
    images: [
  ...
  },
  {
    ...
    price: 399,
    category: "newbalance",
    description: "נעל ספורט קלאסית במראה נקי ואלגנטי שמתאים גם למשרד וגם ליום-יום.",
    images: [
